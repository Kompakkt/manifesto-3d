...
**/
export function eulerFromRotateTransform(transform) {
    var eulerOrder = "XYZ";
    var rdata = transform.Rotation;
    return new Euler(MathUtils.degToRad(rdata.x), MathUtils.degToRad(rdata.y), MathUtils.degToRad(rdata.z), eulerOrder);
}
