...
import { AnnotationBodyParser, ManifestResource, Resource, SpecificResource, TextualBody } from "./internal";
    ...
    **/
    Annotation.prototype.getBody = function () {
        ...
        */
        ...
        if (stringBody) {
            return [new TextualBody({ "id": "https://example.com/TextualBody/1",
                    "value": stringBody,
                    "type": "TextualBody"
                }, this.options)];
        }
