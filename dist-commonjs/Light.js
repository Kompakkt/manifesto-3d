...
var Light = /** @class */ (function (_super) {
    ...
    **/
    ...
    Light.prototype.isAmbientLight = function () {
        return (internal_1.Utils.normaliseType(this.getType() || "") === "ambientlight");
    };
    Light.prototype.isDirectionalLight = function () {
        return (internal_1.Utils.normaliseType(this.getType() || "") === "directionallight");
    };
    Light.prototype.isPointLight = function () {
        return (internal_1.Utils.normaliseType(this.getType() || "") === "pointlight");
    };
    Light.prototype.isSpotLight = function () {
        return (internal_1.Utils.normaliseType(this.getType() || "") === "spotlight");
    };
    return Light;
